...
public class DrawerBuilder {
    ...
    public DrawerBuilder withDrawerLayout(@LayoutRes int resLayout) {
        ...
        if (resLayout != -1) {
            ...
            if (Build.VERSION.SDK_INT < 21) {
                this.mDrawerLayout = (DrawerLayout) mActivity.getLayoutInflater().inflate(com.mikepenz.materialdrawer.R.layout.material_drawer_fits_not, mRootView, false);
            } else {
                this.mDrawerLayout = (DrawerLayout) mActivity.getLayoutInflater().inflate(com.mikepenz.materialdrawer.R.layout.material_drawer, mRootView, false);
            }
        }
    ...
    protected com.mikepenz.materialdrawer.AccountHeader mAccountHeader;
     ...
     * @return
     */
    public DrawerBuilder withAccountHeader(@NonNull com.mikepenz.materialdrawer.AccountHeader accountHeader) {
     ...
     * @return
     */
    public DrawerBuilder withAccountHeader(@NonNull com.mikepenz.materialdrawer.AccountHeader accountHeader, boolean accountHeaderSticky) {
    ...
    // onDrawerListener
    protected com.mikepenz.materialdrawer.Drawer.OnDrawerListener mOnDrawerListener;
     ...
     * @return this
     */
    public DrawerBuilder withOnDrawerListener(@NonNull com.mikepenz.materialdrawer.Drawer.OnDrawerListener onDrawerListener) {
        this.mOnDrawerListener = onDrawerListener;
        return this;
    }

    // onDrawerItemClickListeners
    protected com.mikepenz.materialdrawer.Drawer.OnDrawerItemClickListener mOnDrawerItemClickListener;
     ...
     * @return
     */
    public DrawerBuilder withOnDrawerItemClickListener(@NonNull com.mikepenz.materialdrawer.Drawer.OnDrawerItemClickListener onDrawerItemClickListener) {
        this.mOnDrawerItemClickListener = onDrawerItemClickListener;
        return this;
    }

    // onDrawerItemClickListeners
    protected com.mikepenz.materialdrawer.Drawer.OnDrawerItemLongClickListener mOnDrawerItemLongClickListener;
     ...
     * @return
     */
    public DrawerBuilder withOnDrawerItemLongClickListener(@NonNull com.mikepenz.materialdrawer.Drawer.OnDrawerItemLongClickListener onDrawerItemLongClickListener) {
        this.mOnDrawerItemLongClickListener = onDrawerItemLongClickListener;
        return this;
    }

    // onDrawerListener
    protected com.mikepenz.materialdrawer.Drawer.OnDrawerNavigationListener mOnDrawerNavigationListener;
     ...
     * @return this
     */
    public DrawerBuilder withOnDrawerNavigationListener(@NonNull com.mikepenz.materialdrawer.Drawer.OnDrawerNavigationListener onDrawerNavigationListener) {
    ...
    protected com.mikepenz.materialdrawer.MiniDrawer mMiniDrawer = null;
    ...
    private void handleShowOnLaunch() {
        ...
        if (mActivity != null && mDrawerLayout != null) {
            ...
            if(mShowDrawerOnFirstLaunch && !preferences.getBoolean(com.mikepenz.materialdrawer.Drawer.PREF_USER_LEARNED_DRAWER, false)){
                ...
                editor.putBoolean(com.mikepenz.materialdrawer.Drawer.PREF_USER_LEARNED_DRAWER, true);
                editor.apply();

            } else if(mShowDrawerUntilDraggedOpened && !preferences.getBoolean(com.mikepenz.materialdrawer.Drawer.PREF_USER_OPENED_DRAWER_BY_DRAGGING, false)) {
                    ...
                    public void onDrawerStateChanged(int newState) {
                        if(newState == DrawerLayout.STATE_DRAGGING){
                            ...
                            if(hasBeenDragged && mDrawerLayout.isDrawerOpen(mDrawerGravity)){
                                ...
                                SharedPreferences.Editor editor = preferences.edit();
                                editor.putBoolean(com.mikepenz.materialdrawer.Drawer.PREF_USER_OPENED_DRAWER_BY_DRAGGING, true);
                                editor.apply();
                            } else {
     ...
     * @return
     */
    public com.mikepenz.materialdrawer.Drawer build() {
        if (mUsed) {
        ...
        com.mikepenz.materialdrawer.Drawer result = buildView();
     ...
     * @return
     */
    public com.mikepenz.materialdrawer.Drawer buildForFragment() {
        if (mUsed) {
            throw new RuntimeException("you must not reuse a DrawerBuilder builder");
        }
        if (mActivity == null) {
    ...
    public com.mikepenz.materialdrawer.Drawer buildView() {
        ...
        com.mikepenz.materialdrawer.Drawer result = new com.mikepenz.materialdrawer.Drawer(this);
        ...
        if (mSavedInstance != null && mSavedInstance.getBoolean(com.mikepenz.materialdrawer.Drawer.BUNDLE_DRAWER_CONTENT_SWITCHED, false)) {
     ...
     * @return
     */
    public com.mikepenz.materialdrawer.Drawer append(@NonNull com.mikepenz.materialdrawer.Drawer result) {
        if (mUsed) {
            throw new RuntimeException("you must not reuse a DrawerBuilder builder");
        }
        ...
        //create the result object
        com.mikepenz.materialdrawer.Drawer appendedResult = new com.mikepenz.materialdrawer.Drawer(this);

        //toggle selection list if we were previously on the account list
        if (mSavedInstance != null && mSavedInstance.getBoolean(com.mikepenz.materialdrawer.Drawer.BUNDLE_DRAWER_CONTENT_SWITCHED_APPENDED, false)) {
            mAccountHeader.toggleSelectionList(mActivity);
        }
    ...
    private void createContent() {
        ...
        if (mSelectedItemPosition == 0 && mSelectedItemIdentifier != 0L) {
            mSelectedItemPosition = com.mikepenz.materialdrawer.DrawerUtils.getPositionByIdentifier(this, mSelectedItemIdentifier);
        }
        ...
        if (mSavedInstance != null) {
            if (!mAppended) {
                mAdapter.withSavedInstanceState(mSavedInstance, com.mikepenz.materialdrawer.Drawer.BUNDLE_SELECTION);
                com.mikepenz.materialdrawer.DrawerUtils.setStickyFooterSelection(this, mSavedInstance.getInt(com.mikepenz.materialdrawer.Drawer.BUNDLE_STICKY_FOOTER_SELECTION, -1), null);
            } else {
                mAdapter.withSavedInstanceState(mSavedInstance, com.mikepenz.materialdrawer.Drawer.BUNDLE_SELECTION_APPENDED);
                com.mikepenz.materialdrawer.DrawerUtils.setStickyFooterSelection(this, mSavedInstance.getInt(Drawer.BUNDLE_STICKY_FOOTER_SELECTION_APPENDED, -1), null);
            }
        }
