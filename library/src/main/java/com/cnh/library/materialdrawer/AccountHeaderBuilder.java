package com.cnh.library.materialdrawer;
...
public class AccountHeaderBuilder {
    ...
    protected com.mikepenz.materialdrawer.AccountHeader.OnAccountHeaderProfileImageListener mOnAccountHeaderProfileImageListener;
     ...
     * @return
     */
    public AccountHeaderBuilder withOnAccountHeaderProfileImageListener(com.mikepenz.materialdrawer.AccountHeader.OnAccountHeaderProfileImageListener onAccountHeaderProfileImageListener) {
        this.mOnAccountHeaderProfileImageListener = onAccountHeaderProfileImageListener;
        return this;
    }

    // the onAccountHeaderSelectionListener to set
    protected com.mikepenz.materialdrawer.AccountHeader.OnAccountHeaderSelectionViewClickListener mOnAccountHeaderSelectionViewClickListener;
     ...
     * @return
     */
    public AccountHeaderBuilder withOnAccountHeaderSelectionViewClickListener(com.mikepenz.materialdrawer.AccountHeader.OnAccountHeaderSelectionViewClickListener onAccountHeaderSelectionViewClickListener) {
    ...
    public AccountHeaderBuilder withAccountHeader(@LayoutRes int resLayout) {
        ...
        if (resLayout != -1) {
            ...
            if (mCompactStyle) {
                this.mAccountHeaderContainer = mActivity.getLayoutInflater().inflate(com.mikepenz.materialdrawer.R.layout.material_drawer_compact_header, null, false);
            } else {
                this.mAccountHeaderContainer = mActivity.getLayoutInflater().inflate(com.mikepenz.materialdrawer.R.layout.material_drawer_header, null, false);
            }
        }
    ...
    protected com.mikepenz.materialdrawer.AccountHeader.OnAccountHeaderListener mOnAccountHeaderListener;
     ...
     * @return
     */
    public AccountHeaderBuilder withOnAccountHeaderListener(com.mikepenz.materialdrawer.AccountHeader.OnAccountHeaderListener onAccountHeaderListener) {
    ...
    protected com.mikepenz.materialdrawer.AccountHeader.OnAccountHeaderItemLongClickListener mOnAccountHeaderItemLongClickListener;
     ...
     * @return
     */
    public AccountHeaderBuilder withOnAccountHeaderItemLongClickListener(com.mikepenz.materialdrawer.AccountHeader.OnAccountHeaderItemLongClickListener onAccountHeaderItemLongClickListener) {
        this.mOnAccountHeaderItemLongClickListener = onAccountHeaderItemLongClickListener;
        return this;
    }

    // the drawer to set the AccountSwitcher for
    protected com.mikepenz.materialdrawer.Drawer mDrawer;

    /**
     * @param drawer
     * @return
     */
    public AccountHeaderBuilder withDrawer(@NonNull com.mikepenz.materialdrawer.Drawer drawer) {
        this.mDrawer = drawer;
    ...
    private void setHeaderHeight(int height) {
        if (mAccountHeaderContainer != null) {
            ...
            View accountHeaderBackground = mAccountHeaderContainer.findViewById(com.mikepenz.materialdrawer.R.id.material_drawer_account_header_background);
    ...
    private void handleSelectionView(IProfile profile, boolean on) {
        if (on) {
            if (Build.VERSION.SDK_INT >= 21) {
                ...
                mAccountHeaderContainer.setTag(com.mikepenz.materialdrawer.R.id.material_drawer_profile_header, profile);
            } else {
                ...
                mAccountHeaderTextSection.setTag(com.mikepenz.materialdrawer.R.id.material_drawer_profile_header, profile);
            }
        } else {
            if (Build.VERSION.SDK_INT >= 21) {
    ...
    public com.mikepenz.materialdrawer.AccountHeader build() {
        ...
        mAccountHeader = mAccountHeaderContainer.findViewById(com.mikepenz.materialdrawer.R.id.material_drawer_account_header);

        //the default min header height by default 148dp
        int defaultHeaderMinHeight = mActivity.getResources().getDimensionPixelSize(com.mikepenz.materialdrawer.R.dimen.material_drawer_account_header_height);
        ...
        if (mHeight != null) {
            ...
            if (mCompactStyle) {
                height = mActivity.getResources().getDimensionPixelSize(com.mikepenz.materialdrawer.R.dimen.material_drawer_account_header_height_compact);
            } else {
                //calculate the header height by getting the optimal drawer width and calculating it * 9 / 16
                height = (int) (DrawerUIUtils.getOptimalDrawerWidth(mActivity) * com.mikepenz.materialdrawer.AccountHeader.NAVIGATION_DRAWER_ACCOUNT_ASPECT_RATIO);
        ...
        mAccountHeaderBackground = (ImageView) mAccountHeaderContainer.findViewById(com.mikepenz.materialdrawer.R.id.material_drawer_account_header_background);
        // set the background
        ...
        int textColor = ColorHolder.color(mTextColor, mActivity, com.mikepenz.materialdrawer.R.attr.material_drawer_header_selection_text, com.mikepenz.materialdrawer.R.color.material_drawer_header_selection_text);

        // set the background for the section
        if (mCompactStyle) {
            mAccountHeaderTextSection = mAccountHeader;
        } else {
            mAccountHeaderTextSection = mAccountHeaderContainer.findViewById(com.mikepenz.materialdrawer.R.id.material_drawer_account_header_text_section);
        }
        ...
        // set the arrow :D
        mAccountSwitcherArrow = (ImageView) mAccountHeaderContainer.findViewById(com.mikepenz.materialdrawer.R.id.material_drawer_account_header_text_switcher);
        mAccountSwitcherArrow.setImageDrawable(new IconicsDrawable(mActivity, MaterialDrawerFont.Icon.mdf_arrow_drop_down).sizeRes(com.mikepenz.materialdrawer.R.dimen.material_drawer_account_header_dropdown).paddingRes(com.mikepenz.materialdrawer.R.dimen.material_drawer_account_header_dropdown_padding).color(textColor));

        //get the fields for the name
        mCurrentProfileView = (BezelImageView) mAccountHeader.findViewById(com.mikepenz.materialdrawer.R.id.material_drawer_account_header_current);
        mCurrentProfileName = (TextView) mAccountHeader.findViewById(com.mikepenz.materialdrawer.R.id.material_drawer_account_header_name);
        mCurrentProfileEmail = (TextView) mAccountHeader.findViewById(com.mikepenz.materialdrawer.R.id.material_drawer_account_header_email);
        ...
        mProfileFirstView = (BezelImageView) mAccountHeader.findViewById(com.mikepenz.materialdrawer.R.id.material_drawer_account_header_small_first);
        mProfileSecondView = (BezelImageView) mAccountHeader.findViewById(com.mikepenz.materialdrawer.R.id.material_drawer_account_header_small_second);
        mProfileThirdView = (BezelImageView) mAccountHeader.findViewById(com.mikepenz.materialdrawer.R.id.material_drawer_account_header_small_third);
        ...
        if (mSavedInstance != null) {
            int selection = mSavedInstance.getInt(com.mikepenz.materialdrawer.AccountHeader.BUNDLE_SELECTION_HEADER, -1);
            if (selection != -1) {
        ...
        return new com.mikepenz.materialdrawer.AccountHeader(this);
    }
     ...
     */
    private com.mikepenz.materialdrawer.Drawer.OnDrawerItemClickListener onDrawerItemClickListener = new com.mikepenz.materialdrawer.Drawer.OnDrawerItemClickListener() {
        @Override
     ...
     */
    private com.mikepenz.materialdrawer.Drawer.OnDrawerItemLongClickListener onDrawerItemLongClickListener = new Drawer.OnDrawerItemLongClickListener() {
        @Override
