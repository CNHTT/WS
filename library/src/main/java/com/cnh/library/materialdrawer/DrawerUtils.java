...
class DrawerUtils {
    ...
    public static void handleHeaderView(DrawerBuilder drawer) {
        ...
        if (drawer.mStickyHeaderView != null) {
            ...
            drawer.mStickyHeaderView.setId(com.mikepenz.materialdrawer.R.id.material_drawer_sticky_header);
            ...
            layoutParamsListView.addRule(RelativeLayout.BELOW, com.mikepenz.materialdrawer.R.id.material_drawer_sticky_header);
            drawer.mRecyclerView.setLayoutParams(layoutParamsListView);

            //set a background color or the elevation will not work
            drawer.mStickyHeaderView.setBackgroundColor(UIUtils.getThemeColorFromAttrOrRes(drawer.mActivity, com.mikepenz.materialdrawer.R.attr.material_drawer_background, com.mikepenz.materialdrawer.R.color.material_drawer_background));
            ...
            if (drawer.mStickyHeaderShadow) {
                ...
                if (Build.VERSION.SDK_INT >= 21) {
                    ...
                    view.setBackgroundResource(com.mikepenz.materialdrawer.R.drawable.material_drawer_shadow_bottom);
                    ...
                    lps.addRule(RelativeLayout.BELOW, com.mikepenz.materialdrawer.R.id.material_drawer_sticky_header);
    ...
    public static void handleFooterView(DrawerBuilder drawer, View.OnClickListener onClickListener) {
        ...
        if (drawer.mStickyFooterView != null) {
            ...
            drawer.mStickyFooterView.setId(com.mikepenz.materialdrawer.R.id.material_drawer_sticky_footer);
            ...
            RelativeLayout.LayoutParams layoutParamsListView = (RelativeLayout.LayoutParams) drawer.mRecyclerView.getLayoutParams();
            layoutParamsListView.addRule(RelativeLayout.ABOVE, com.mikepenz.materialdrawer.R.id.material_drawer_sticky_footer);
            drawer.mRecyclerView.setLayoutParams(layoutParamsListView);

            //handle shadow on top of the sticky footer
            if (drawer.mStickyFooterShadow) {
                drawer.mStickyFooterShadowView = new View(ctx);
                drawer.mStickyFooterShadowView.setBackgroundResource(com.mikepenz.materialdrawer.R.drawable.material_drawer_shadow_top);
                drawer.mSliderLayout.addView(drawer.mStickyFooterShadowView, RelativeLayout.LayoutParams.MATCH_PARENT, ctx.getResources().getDimensionPixelSize(com.mikepenz.materialdrawer.R.dimen.material_drawer_sticky_footer_elevation));
                //now align the shadow below the stickyHeader ;)
                RelativeLayout.LayoutParams lps = (RelativeLayout.LayoutParams) drawer.mStickyFooterShadowView.getLayoutParams();
                lps.addRule(RelativeLayout.ABOVE, com.mikepenz.materialdrawer.R.id.material_drawer_sticky_footer);
            ...
            drawer.mRecyclerView.setPadding(drawer.mRecyclerView.getPaddingLeft(), drawer.mRecyclerView.getPaddingTop(), drawer.mRecyclerView.getPaddingRight(), ctx.getResources().getDimensionPixelSize(com.mikepenz.materialdrawer.R.dimen.material_drawer_padding));
        }
    ...
    public static ViewGroup buildStickyDrawerItemFooter(Context ctx, DrawerBuilder drawer, View.OnClickListener onClickListener) {
        ...
        linearLayout.setBackgroundColor(UIUtils.getThemeColorFromAttrOrRes(ctx, com.mikepenz.materialdrawer.R.attr.material_drawer_background, com.mikepenz.materialdrawer.R.color.material_drawer_background));
    ...
    private static void addStickyFooterDivider(Context ctx, ViewGroup footerView) {
        ...
        divider.setBackgroundColor(UIUtils.getThemeColorFromAttrOrRes(ctx, com.mikepenz.materialdrawer.R.attr.material_drawer_divider, com.mikepenz.materialdrawer.R.color.material_drawer_divider));
    ...
    public static DrawerLayout.LayoutParams processDrawerLayoutParams(DrawerBuilder drawer, DrawerLayout.LayoutParams params) {
        if (params != null) {
            if (drawer.mDrawerGravity != null && (drawer.mDrawerGravity == Gravity.RIGHT || drawer.mDrawerGravity == Gravity.END)) {
                ...
                params.leftMargin = drawer.mActivity.getResources().getDimensionPixelSize(com.mikepenz.materialdrawer.R.dimen.material_drawer_margin);
                if (Build.VERSION.SDK_INT >= 17) {
                    params.setMarginEnd(drawer.mActivity.getResources().getDimensionPixelSize(com.mikepenz.materialdrawer.R.dimen.material_drawer_margin));
                }
            }
